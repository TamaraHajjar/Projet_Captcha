# --------------------------- CODE BIEN ---------------------------
'''
Ce code est pour appliquer le gaussian filtering sur une image grayscaled
'''
...
# Apply Gaussian filtering to each channel separately (R, G, B)
...
for i in range(3):  # 0 - Blue, 1 - Green, 2 - Red
    denoised_image[:, :, i] = cv2.GaussianBlur(image[:, :, i], (3, 3), 0)  # (5, 5) is the kernel size
